...
# Form implementation generated from reading ui file 'C:\Users\Lin\Desktop\Pyquino\core\vrep\vrep_setting.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.tx = QtWidgets.QDoubleSpinBox(self.widget)
        self.tx.setObjectName("tx")
        self.verticalLayout.addWidget(self.tx)
        self.ty = QtWidgets.QDoubleSpinBox(self.widget)
        self.ty.setObjectName("ty")
        self.verticalLayout.addWidget(self.ty)
        self.tz = QtWidgets.QDoubleSpinBox(self.widget)
        self.tz.setObjectName("tz")
        self.verticalLayout.addWidget(self.tz)
        self.horizontalLayout_4.addLayout(self.verticalLayout)
        self.translate = QtWidgets.QPushButton(self.widget)
        self.translate.setObjectName("translate")
        self.horizontalLayout_4.addWidget(self.translate)
        self.translateShow = QtWidgets.QListWidget(self.widget)
        self.translateShow.setObjectName("translateShow")
        self.horizontalLayout_4.addWidget(self.translateShow)
